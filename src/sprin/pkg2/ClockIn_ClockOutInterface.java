 ...
 * @author wongc
 */
public class ClockIn_ClockOutInterface extends javax.swing.JFrame {
    ...
    public ClockIn_ClockOutInterface() {
        //createConnection();
        initComponents();
  ...
  public void createConnection()
    ...
    private void initComponents() {
        ...
        lblcusIID.setText("Delivery man name : ");

        lblRestaurant.setText("Clock in time : ");

        cbCategory.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Time", "10am", "1pm", "" }));
        ...
        lblMenuItem.setText("Clock out time :");

        cbPrepareTime.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select clock out time", "7pm ", "10pm", " " }));
        cbPrepareTime.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbPrepareTimeActionPerformed(evt);
            }
        });
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Clock In Time", "Clock Out Time"
            }
        ) {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        model.addRow(new Object[]{name, category, prepareTime});
    ...
    private void cbPrepareTimeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbPrepareTimeActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cbPrepareTimeActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClockIn_ClockOutInterface.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClockIn_ClockOutInterface().setVisible(true);
